                        ...
                        <?php echo csrf_field(); ?>
                         <div class="d-flex justify-content-center align-items-center mb-3">
                             <div class="shiny-image">
                              <a href="<?php echo e(asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)); ?>" class="fancybox" data-fancybox="gallery" data-caption="Foto Profile yang bagus">
                              <img src="<?php echo e(asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)); ?>" style="width: 190px; height:190px;" class="img-preview rounded-circle <?php if($errors->has('foto')): ?> is-invalid <?php endif; ?>" alt="">
                              </a>
                              </div>
                        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\SiswaLogin\ubahFoto.blade.php ENDPATH**/ ?>