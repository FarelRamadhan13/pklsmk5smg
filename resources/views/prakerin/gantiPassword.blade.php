            ...
            text: '{{ session('gagal') }}',
                ...
                <form action="" method="post">
                    ...
                    <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif" name="name" id="name" placeholder="" value="<?php if(old('name')){ echo old('name'); }else{ echo auth()->user()->name; }?>">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('username')) is-invalid @endif" name="username" id="username" placeholder="" value="<?php if(old('username')){ echo old('username'); }else{ echo auth()->user()->username; }?>">
                            @if(auth()->user()->hak_akses == '2')<label for="username">Username</label> @else <label for="username">NIP</label>@endif
