                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="idprakerin" id="idprakerin" class="form-select <?php if($errors->has('idprakerin')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $prakerin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->idprakerin); ?>" <?php if(old('idprakerin') == $p->idprakerin){ echo 'selected'; } ?>><?php echo e($p->idprakerin); ?></option>    
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\kunjungan\tambah.blade.php ENDPATH**/ ?>