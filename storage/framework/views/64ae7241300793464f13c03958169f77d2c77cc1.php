            ...
            <div class="card mt-5">
                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="Form">
                        ...
                        <div class="form-floating mb-3 col-md-10">
                            <input type="text" class="form-control <?php if($errors->has('nama_instruktur')): ?> is-invalid <?php endif; ?>" name="nama_instruktur" id="nama_instruktur" placeholder="" value="<?php echo e(old('nama_instruktur')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\jurnalPKL\tambah.blade.php ENDPATH**/ ?>