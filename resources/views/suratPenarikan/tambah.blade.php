                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-10 mb-3">
                            ...
                            <select name="prakerin" id="prakerin" class="form-select @if($errors->has('prakerin')) is-invalid @endif">
                                ...
                                @foreach($prakerin as $p)
                                    <option value="{{$p->idprakerin}}" <?php if(old('prakerin') == $p->idprakerin){ echo 'selected'; } ?>>Id Prakerin: {{$p->idprakerin}} || NIS: {{$p->nisn}} || Nama: {{$p->nama_siswa}}</option>    
                                @endforeach
                            </select>
                        ...
                        <div class="form-floating mb-3 col-md-10">
                            <input type="text" class="form-control @if($errors->has('alasan')) is-invalid @endif" name="alasan" id="alasan" placeholder="" value="{{old('alasan')}}">
