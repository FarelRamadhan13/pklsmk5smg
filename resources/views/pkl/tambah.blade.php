            ...
            <div class="card mt-5">
                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('alamat')) is-invalid @endif" name="alamat" id="alamat" placeholder="" value="{{old('alamat')}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control @if($errors->has('quota')) is-invalid @endif" name="quota" id="quota" placeholder="" value="{{old('quota')}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('nama_pimpinan')) is-invalid @endif" name="nama_pimpinan" id="nama_pimpinan" placeholder="" value="{{old('nama_pimpinan')}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('bidang_usaha')) is-invalid @endif" name="bidang_usaha" id="bidang_usaha" placeholder="" value="{{old('bidang_usaha')}}">
