                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="id_pkl" id="id_pkl" class="form-select <?php if($errors->has('id_pkl')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $pkl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->idpkl); ?>" <?php if(old('id_pkl')){ if(old('id_pkl') == $p->idpkl){ echo 'selected'; }}else{ if($prakerin->idpkl == $p->idpkl){ echo 'selected'; } } ?>><?php echo e($p->idpkl); ?> || <?php echo e($p->nama_pkl); ?></option>    
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="nisn" id="nisn" class="form-select <?php if($errors->has('nisn')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->nisn); ?>" <?php if(old('nisn')){ if(old('nisn') == $s->nisn){ echo 'selected'; }}else{ if($prakerin->nisn == $s->nisn){ echo 'selected'; } } ?>><?php echo e($s->nisn); ?> || <?php echo e($s->nama_siswa); ?></option>    
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="nip" id="nip" class="form-select <?php if($errors->has('nip')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $guru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($g->nip); ?>" <?php if(old('nip')){ if(old('nip') == $g->nip){ echo 'selected'; }}else{ if($prakerin->nip == $g->nip){ echo 'selected'; } } ?>><?php echo e($g->nip); ?> || <?php echo e($g->nama); ?></option>    
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <input type="date" name="start" id="start" class="form-control <?php if($errors->has('start')): ?> is-invalid <?php endif; ?>" value="<?php if(old('start')){ echo old('start'); }else{ echo $prakerin->start; } ?>">
                        ...
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <input type="date" name="end" id="end" class="form-control <?php if($errors->has('end')): ?> is-invalid <?php endif; ?>" value="<?php if(old('end')){ echo old('end'); }else{ echo $prakerin->end; } ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\tb_prakerin\ubah.blade.php ENDPATH**/ ?>