                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('nip')) is-invalid @endif" name="nip" id="nip" placeholder="" value="{{old('nip')}}">
                        ...
                        <div class="form-floating mb-3">
                        <textarea class="form-control @if($errors->has('alamat')) is-invalid @endif" name="alamat" id="alamat" placeholder="">{{ old('alamat') }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('pangkat')) is-invalid @endif" name="pangkat" id="pangkat" placeholder="" value="{{old('pangkat')}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @if($errors->has('jabatan')) is-invalid @endif" name="jabatan" id="jabatan" placeholder="" value="{{old('jabatan')}}">
