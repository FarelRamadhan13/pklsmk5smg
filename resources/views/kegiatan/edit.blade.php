                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="Form">
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="{{asset('storage/foto_kegiatan/' . $kegiatan->foto)}}" class="fancybox" data-fancybox="gallery">
                                        <img src="{{asset('storage/foto_kegiatan/' . $kegiatan->foto)}}" style="width: 150px; height:130px;" class="img-preview @if($errors->has('foto')) is-invalid @endif" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="form-floating my-3">
                            <input type="text" class="form-control @if($errors->has('uraian')) is-invalid @endif" name="uraian" id="uraian" placeholder="" value="<?php if (old('uraian')) {
                                                                                                                                                                        echo old('uraian');
                                                                                                                                                                    } else {
