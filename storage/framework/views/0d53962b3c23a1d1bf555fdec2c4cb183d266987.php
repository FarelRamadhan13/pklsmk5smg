...
<?php endif; ?>
    ...
    <a class="download-btn fixed-bottom-right" href="/Siswa/JurnalPKL/harian/pdf/<?php echo e($id); ?>" id="animatedBtn">
        <svg
          id="download"
          viewBox="0 0 24 24"
          data-name="Layer 1"
            ...
            <div class="card mt-5">
               <div class="card-header text-center py-4">
                    <div class="d-flex justify-content-center align-items-center">
                         <h1 class="mb-0" id="student-name">Daftar Kegiatan harian <?php echo e($jurnal->nama_siswa); ?></h1>
                        <script>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="d-flex justify-content-end my-3">
                       ...
                       <div class="col-auto">
                            <?php if($cek_kegiatan->start > $hari_ini): ?>
                            <p>Belum memulai prakerin</p>
                            <?php elseif($cek_kegiatan->end < $hari_ini): ?>
...
<?php if($cek_hadir > 0 && $cek_sakit == 0): ?>
<a class="button text-decoration-none" type="button" href="/Siswa/JurnalPKL/harian/tambah/<?php echo e($id); ?>" >
    <span class="button__text">Tambah</span>
    <span class="button__icon"><svg class="svg" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><line x1="12" x2="12" y1="5" y2="19"></line><line x1="5" x2="19" y1="12" y2="12"></line></svg></span>
</a>
<?php elseif($cek_sakit > 0): ?>
<a>Izin</a>
<?php else: ?>
    ...
    .table td {
        ...
        white-space: normal;
                              ...
                              <div class="pengingat mt-4">
                                <a class="pengingat1" href="/Siswa/JurnalPKL/Absensi/<?php echo e($jurnal->id); ?>">
                                 <p>Absen hadir</p>
                                 ...
                                 <div class="go-corner" href="/Siswa/JurnalPKL/Absensi/<?php echo e($jurnal->id); ?>">
                                   <div class="go-arrow">
                                     →
                                   </div>
                                 </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table-striped table table-bordered align-middle text-center" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><?php echo e($jumlah_kegiatan--); ?></td>
                                   <?php
...
<td class="text-center">
       <?php if ($u->foto == null) { ?>
                                            -
                                        <?php } else { ?>
                                            <a href="<?php echo e(asset('storage/foto_kegiatan/' . $u->foto)); ?>" class="fancybox" data-fancybox="gallery" data-caption="Pada hari <?php echo e($hari); ?> tanggal <?php echo e($hanya_tanggal); ?>, <?php echo e($u->uraian); ?>">
                                                <img loading="lazy" src="<?php echo e(asset('storage/foto_kegiatan/' . $u->foto)); ?>" style="height: 150px; width: 150px; image-rendering: pixelated;" alt="" title="lihat foto">
                                            </a>
                                        <?php } ?>
   </td>
                                  ...
                                  <td class="text-center">
    <?php if(strlen($u->uraian) > 20): ?>
        <?php echo e(substr($u->uraian, 0, 20)); ?>... <a href="<?php echo e(asset('storage/foto_kegiatan/' . $u->foto)); ?>" class="fancybox" data-fancybox="gallery" data-caption="Pada hari <?php echo e($hari); ?> tanggal <?php echo e($hanya_tanggal); ?>, <?php echo e($u->uraian); ?>">Lihat Selengkapnya</a>
    <?php else: ?>
        <?php echo e($u->uraian); ?>
    ...
    <?php endif; ?>
                                    ...
                                    <td class="text-center p-2">
                                        ...
                                        <form id="delete-form-<?php echo e($id); ?>-<?php echo e($u->id_kegiatan); ?>" action="<?php echo e(route('harian.destroy', ['id' => $id, 'id_kegiatan' => $u->id_kegiatan])); ?>" method="POST" style="display: none;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($id); ?>-<?php echo e($u->id_kegiatan); ?>" style="display: none;"><i class="fa-solid fa-trash"></i> </button>
                                        </form>

                                        <a href="#" class="btn btn-danger delete-user" data-id="<?php echo e($id); ?>" kegiatan-id="<?php echo e($u->id_kegiatan); ?>">
                                            <i class="fa-solid fa-trash"></i> 
                                        </a>
                                        <a href="/Siswa/JurnalPKL/harian/<?php echo e($id); ?>/ubah/<?php echo e($u->id_kegiatan); ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <?php else: ?>
                                        <?php if($u->tanggal == $hari_ini): ?>
                                        <form id="delete-form-<?php echo e($id); ?>-<?php echo e($u->id_kegiatan); ?>" action="<?php echo e(route('harian.destroy', ['id' => $id, 'id_kegiatan' => $u->id_kegiatan])); ?>" method="POST" style="display: none;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($id); ?>-<?php echo e($u->id_kegiatan); ?>" style="display: none;"><i class="fa-solid fa-trash"></i> </button>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\kegiatan\index.blade.php ENDPATH**/ ?>