        ...
        <div class="col-md-3 text-center">
            <a href="#" class="fancybox img-preview-link" data-fancybox="gallery">
                <img id="fotoPreview" 
                     ...
                     class="img-preview <?php if($errors->has('foto')): ?> is-invalid <?php endif; ?>" 
                     alt="Foto Preview">
            </a>
        </div>
        <div class="col-md-7">
...
<script src="<?php echo e(asset('aset/js/script3.js')); ?>">

</script>
<script src="<?php echo e(asset('aset/js/GetTheLocation.js')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\hadir\pulang.blade.php ENDPATH**/ ?>