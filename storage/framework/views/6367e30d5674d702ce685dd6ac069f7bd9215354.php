...
<div id="welcome-screen" class="d-flex justify-content-center align-items-center position-fixed start-0 w-100 h-100 bg-white">
    <div class="text-center">
        <img id="profile-picture" 
             src="<?php echo e(asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)); ?>" 
             alt="Foto Profil" 
        ...
        <div class="col-md-7">
            <div class="card mt-5">
                ...
                <div class="card-body p-5">
                    ...
                    <script>
                        var pesan = "<?php echo e(session('berhasil')); ?>";
                    ...
                    <script>
                        var pesan = "<?php echo e(session('gagal')); ?>";
                        Swal.fire({
                            icon: 'error',
                            title: 'Gagal!',
                            text: pesan
                    ...
                    <div class="container" >
                        <div class="mx-auto d-flex justify-content-center align-items-center position-relative">
                            <div class="shiny-image">
                                <a href="<?php echo e(asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)); ?>" data-fancybox="gallery" data-caption="Foto Profil <?php echo e(auth()->guard('siswa')->user()->nama_siswa); ?> <?php if(auth()->guard('siswa')->user()->foto_siswa == 'default.png'): ?> (kosong) <?php endif; ?>">
                                    <img src="<?php echo e(asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)); ?>" style="width: 15.5vh; height: 15.5vh;" alt="Foto Profil <?php echo e(auth()->guard('siswa')->user()->nama_siswa); ?>" class="rounded-circle" id="profileImage">
                                </a>
                            </div>
                        ...
                        <?php if($jurnal != null): ?>
                            ...
                            <div class="mt-4 row justify-content-center align-items-center">
                                <div class="col-md-6 mt-4">
                                    <a href="/Siswa/JurnalPKL/Absen/<?php echo e($jurnal->id); ?>" class="depan text-start">
                                        <span class="title"><i class="fa-solid fa-door-open"></i> Absen</span>
                                        <?php if($cek_sakit == 0): ?>
                                        <p class="status text-decoration-none">Absen Datang hari ini: <?php if($cek_hadir < 1): ?> - <?php else: ?> <?php if($cek_absen != null): ?> <?php echo e($cek_absen->waktu_datang); ?> <?php else: ?> - <?php endif; ?> <?php endif; ?></p>
                                        <p class="status text-decoration-none">Absen Pulang hari ini: <?php if($absen == null && $cek_hadir == 1): ?> <?php if($cek_absen != null): ?> <?php echo e($cek_absen->waktu_pulang); ?> <?php else: ?> - <?php endif; ?> <?php else: ?> - <?php endif; ?></p>
                                        <?php else: ?>
                                ...
                                <div class="col-md-6 mt-4">
                                    <a href="/Siswa/JurnalPKL/harian/<?php echo e($jurnal->id); ?>" class="depan text-start">
                        ...
                        <table class="table mt-5">
                            <tbody>
                                <tr class="table-row">
                                    <th scope="row">NIS</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->nisn); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Nama</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->nama_siswa); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Alamat</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->alamat); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Nomor telephone</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->telp); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Kelas</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->kelas); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Tahun</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->tahun); ?></td>
                                </tr>
                                <tr class="table-row">
                                ...
                                <tr class="table-row">
                                    ...
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->golongan_darah ?? '-'); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Nama Orang tua / wali</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->nama_orang_tua_wali ?? '-'); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Tempat, tanggal lahir</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->tempat_tanggal_lahir ?? '-'); ?></td>
                                </tr>
                                <tr class="table-row">
                                    <th scope="row">Catatan kesehatan</th>
                                    <td>:</td>
                                    <td><?php echo e(auth()->guard('siswa')->user()->catatan_kesehatan ?? '-'); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
document.addEventListener("DOMContentLoaded", () => {
    const fullName = "<?php echo e(auth()->guard('siswa')->user()->nama_siswa); ?>";
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\SiswaLogin\index.blade.php ENDPATH**/ ?>