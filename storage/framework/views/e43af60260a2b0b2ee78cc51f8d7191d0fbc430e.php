                    ...
                    <table class="table-striped table table-bordered align-middle" id="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center"><?php echo e($u->id_izin); ?></td>
                                    ...
                                    <td class="text-center"><?php echo e($u->tempat); ?></td>
                                    <?php
                                    ...
                                    <td class="text-center"><a href="/suratIzin/lihat/<?php echo e($u->id_izin); ?>" target="_BLANK"><i class="fa-solid fa-download"></i></a></td>
                                    <?php if(auth()->check()): ?>
                                    <td class="text-center"> <form id="delete-form-<?php echo e($u->id_izin); ?>" action="<?php echo e(route('izin.destroy', $u->id_izin)); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
    <?php echo method_field('DELETE'); ?>
    <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($u->id_izin); ?>" style="display: none;">Hapus</button>
</form>

<a href="#" class="btn btn-danger delete-user" data-id="<?php echo e($u->id_izin); ?>">
    Hapus
</a>   <a href="/Admin/suratIzin/edit/<?php echo e($u->id_izin); ?>" class="btn btn-warning">Ubah</a> </td>
                                    <?php endif; ?>
                                </tr>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\suratIzin\index.blade.php ENDPATH**/ ?>