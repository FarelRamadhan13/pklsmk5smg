...
.button-loc:active {
  ...
  transform: translateY(2px);
    ...
    @if(in_array(auth()->guard('siswa')->user()->kelas, ['XI', 'XII']))
    <script>
        function kelasTidakSesuai(){
            Swal.fire({
                title: 'Kelas Tidak Sesuai!',
                text: "Halo {{ ucwords(strtolower(auth()->guard('siswa')->user()->nama_siswa)) }}, data kelas kamu tidak sesuai. Silahkan ubah kelas kamu di edit profile terlebih dahulu sebelum melanjutkan!",
                icon: 'warning',
  ...
  100% {
    transform: translateX(0);
                            ...
                            <div class="col-auto text-center mt-4">
                                ...
                                <div class="radio-input  @if($errors->has('izin')) is-invalid @endif">
                                    <input value="0" name="izin" id="hadir" type="radio" @if(old('izin') == '0') checked @endif>
                                    <label for="hadir" onclick="toggleElements('hadir')">Hadir</label>
                                    <input value="1" name="izin" id="absen" type="radio" @if(old('izin') == '1') checked @endif>
                        ...
                        <div class="form-group mb-3" id="fotoContainer" style="display: none;">
                            <div class="row">
                                <div class="col-md-3">
                                  <a href="{{asset('storage/absen/selfie.gif')}}" data-fancybox="gallery" class="img-preview-link">
                                    <img src="{{asset('storage/absen/selfie.gif')}}" style="width: 100px; height:100px;" class="img-preview @if($errors->has('foto')) is-invalid @endif" alt="">
                                </a>
                                </div>
                                <div class="col-md-7">

                                    <label for="" id="fotoLabel">Inputkan Foto kamu saat di Industri</label>
                                    <input type="file" name="izin" id="izin" style="display: none;" class=" form-control @if($errors->has('izin')) is-invalid @endif" onchange="previewImg()" accept="image/*">

                                     <button type="button" id="fotoButton" class=" btn btn-primary @if($errors->has('capturedImage')) is-invalid @endif" onclick="captureImage()" style="display: none;"><i class="fa-solid fa-camera"></i> Ambil Foto</button>
...
<script src="{{ asset('aset/js/script3.js') }}"></script>



<script src="{{ asset('aset/js/GetTheLocation.js') }}"></script>
