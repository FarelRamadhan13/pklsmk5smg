                    ...
                    <form action="" method="post" id="Form">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="pkl" id="pkl" class="form-select <?php if($errors->has('pkl')): ?> is-invalid <?php endif; ?>">
                                ...
                                <option value="<?php echo e($j->idpkl); ?>" <?php if(old('pkl') == $j->idpkl){ echo 'selected'; } ?>><?php echo e($j->nama_pkl); ?> || Bidang Usaha: <?php echo e($j->bidang_usaha); ?> || quota: <?php echo e($j->quota_pkl); ?> Siswa</option>
                        ...
                        <div class="form-group  mb-3" id="form-siswa1">
                            ...
                            <select name="siswa1" id="siswa1" class="form-select <?php if($errors->has('siswa1')): ?> is-invalid <?php endif; ?>">
                               <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->nisn); ?>" <?php if(old('siswa1') == $s->nisn){ echo 'selected'; } ?>>Nama: <?php echo e($s->nama_siswa); ?> || NIS <?php echo e($s->nisn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php if($errors->has('siswa1')): ?> 
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group mb-3" id="form-siswa2">
                            ...
                            <select name="siswa2" id="siswa2" class="form-select <?php if($errors->has('siswa2')): ?> is-invalid <?php endif; ?>">
                               <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->nisn); ?>" <?php if(old('siswa2') == $s->nisn){ echo 'selected'; } ?>>Nama: <?php echo e($s->nama_siswa); ?> || NIS <?php echo e($s->nisn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group mb-3" id="form-siswa3">
                            ...
                            <select name="siswa3" id="siswa3" class="form-select <?php if($errors->has('siswa3')): ?> is-invalid <?php endif; ?>">
                               <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->nisn); ?>" <?php if(old('siswa3') == $s->nisn){ echo 'selected'; } ?>>Nama: <?php echo e($s->nama_siswa); ?> || NIS <?php echo e($s->nisn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group mb-3" id="form-siswa4">
                            ...
                            <select name="siswa4" id="siswa4" class="form-select <?php if($errors->has('siswa4')): ?> is-invalid <?php endif; ?>">
                               <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->nisn); ?>" <?php if(old('siswa4') == $s->nisn){ echo 'selected'; } ?>>Nama: <?php echo e($s->nama_siswa); ?> || NIS <?php echo e($s->nisn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group mb-3 col-md-6">
                         ...
                         <select class="form-select <?php if($errors->has('tahunPelajaran')): ?> is-invalid <?php endif; ?>" name="tahunPelajaran" id="tahunPelajaran" value="<?php echo e(old('tahunPelajaran')); ?>">
                            ...
                            <input type="date" name="mulai" id="mulai" class="form-control <?php if($errors->has('mulai')): ?> is-invalid <?php endif; ?>" value="<?php echo e(old('mulai')); ?>">
                            ...
                            <input type="number" class="form-control <?php if($errors->has('lama')): ?> is-invalid <?php endif; ?>" name="lama" id="lama" placeholder="" value="<?php echo e(old('lama')); ?>" readonly>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\SiswaLogin\pengajuan.blade.php ENDPATH**/ ?>