                        ...
                        <tbody>
                            <?php $__currentLoopData = $surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php if(auth()->check() && !auth()->user()->hak_akses == '0' || !auth()->guard('pendamping')->check()): ?>
                                    <td class="text-center"><a href="/Pendamping/Pengajuan/file/<?php echo e($u->id); ?>" target="_BLANK">Lihat FIle</a></td>
                                    <?php endif; ?>
                                    <td class="text-center">  <form id="delete-form-<?php echo e($u->id); ?>" action="<?php echo e(route('tugas.destroy', $u->id)); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
    <?php echo method_field('DELETE'); ?>
    <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($u->id); ?>" style="display: none;">Hapus</button>
</form>

<a href="#" class="btn btn-danger delete-user" data-id="<?php echo e($u->id); ?>" username="<?php echo e($u->nama); ?>">
    Hapus
</a>  <a href="/Pendamping/Pengajuan/ubah/<?php echo e($u->id); ?>" class="btn btn-warning">Ubah</a> </td>
                                </tr>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\surat_guru_pendamping\index.blade.php ENDPATH**/ ?>