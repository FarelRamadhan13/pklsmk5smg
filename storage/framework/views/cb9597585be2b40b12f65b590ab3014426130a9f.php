  ...
  transform: scale(0.95);
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="Form">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('nisn')): ?> is-invalid <?php endif; ?>" name="nisn" id="nisn" placeholder="" value="<?php echo e($siswa->nisn); ?>" readonly>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('nama')): ?> is-invalid <?php endif; ?>" name="nama" id="nama" placeholder="" value="<?php echo e($siswa->nama_siswa); ?>">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('alamat')): ?> is-invalid <?php endif; ?>" name="alamat" id="alamat" placeholder="" value="<?php echo e($siswa->alamat); ?>">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('telp')): ?> is-invalid <?php endif; ?>" name="telp" id="telp" placeholder="" value="<?php echo e($siswa->telp); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php for($i = 1; $i <= 3; $i++): ?>
                                        ...
                                        ?>
                                        <option value="<?php echo e($value); ?>" <?php if(trim(old('kelas', $siswa->kelas)) == trim($value)): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                                    <?php endfor; ?>
                                    <?php for($i = 1; $i <= 3; $i++): ?>
                                        <?php
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control <?php if($errors->has('tahun')): ?> is-invalid <?php endif; ?>" name="tahun" id="tahun" placeholder="" value="<?php echo e($siswa->tahun); ?>">
                        ...
                        <div class="form-group mb-3 col-md-5">
                            <select name="jurusan" id="jurusan" class="form-select <?php if($errors->has('jurusan')): ?> is-invalid <?php endif; ?>">
                                ...
                                <option value="<?php echo e($j->id_jurusan); ?>" <?php if($siswa->id_jurusan == $j->id_jurusan){ echo 'selected'; } ?>><?php echo e($j->nama_jurusan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<hr>
<div class="form-floating mb-3">
    <input type="text" class="form-control <?php if($errors->has('tampat_tanggal_lahir')): ?> is-invalid <?php endif; ?>" name="tampat_tanggal_lahir" id="tampat_tanggal_lahir" placeholder="" value="<?php if(old('tempat_tanggal_lahir')){ echo old('tempat_tanggal_lahir'); }else{ echo $siswa->tempat_tanggal_lahir; } ?>" >
    ...
    <div class="form-floating mb-3 col-md-8">
                            <input type="text" class="form-control <?php if($errors->has('nama_ortu')): ?> is-invalid <?php endif; ?>" name="nama_ortu" id="nama_ortu" placeholder="" value="<?php if(old('nama_ortu')){ echo old('nama_ortu'); }else{ echo $siswa->nama_orang_tua_wali; } ?>" >
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('catatan_kesehatan')): ?> is-invalid <?php endif; ?>" name="catatan_kesehatan" id="catatan_kesehatan" placeholder="" value="<?php if(old('catatan_kesehatan')){ echo old('catatan_kesehatan'); }else{ echo $siswa->catatan_kesehatan; } ?>" >
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\SiswaLogin\edit.blade.php ENDPATH**/ ?>