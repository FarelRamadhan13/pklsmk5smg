                        ...
                        @csrf
                         <div class="d-flex justify-content-center align-items-center mb-3">
                             <div class="shiny-image">
                              <a href="{{ asset('storage/foto_profile_siswa/' . auth()->guard('pendamping')->user()->foto_pendamping) }}" class="fancybox" data-fancybox="gallery" data-caption="Foto Profile yang bagus">
                              <img src="{{asset('storage/foto_profile_siswa/' . auth()->guard('pendamping')->user()->foto_pendamping)}}" style="width: 190px; height:190px;" class="img-preview rounded-circle @if($errors->has('foto')) is-invalid @endif" alt="">
                              </a>
                              </div>
                        </div>
