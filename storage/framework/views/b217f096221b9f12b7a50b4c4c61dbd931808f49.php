                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3 col-md-6" >
                            <input type="number" class="form-control <?php if($errors->has('tahun')): ?> is-invalid <?php endif; ?>" name="tahun" id="tahun" placeholder="" value="<?php echo e(date('Y')); ?>">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="date" name="tanggal" id="tanggal" class="form-control <?php if($errors->has('tanggal')): ?> is-invalid <?php endif; ?>" value="<?php if(old('tanggal')){ echo old('tanggal'); }elseif(isset($surat->tanggal)){ echo $surat->tanggal; }else{ echo date('Y-m-d'); } ?>">
                            ...
                            <input type="date" class="form-control <?php if($errors->has('pada_tanggal')): ?> is-invalid <?php endif; ?>" name="pada_tanggal" id="pada_tanggal" placeholder="" value="<?php if(old('padat_tanggal')){ echo old('pada_tanggal'); }else{ echo $surat->pada_tanggal; } ?>" >
                        ...
                        <input type="time" id="waktu" name="waktu" class="form-control <?php if($errors->has('waktu')): ?> is-invalid <?php endif; ?>" value="<?php if(old('waktu')){ echo old('waktu'); }else{ echo $surat->waktu; } ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <option value="" disabled selected hidden>Pilih Siswa</option>
                                <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->nisn); ?>" <?php if(old('siswa')){ if(old('siswa') == $p->nisn){ echo 'selected'; }}else{ if($surat->siswa == $p->nisn){ echo 'selected'; }} ?>><?php echo e($p->nama_siswa); ?> || NIS: <?php echo e($p->nisn); ?></option>    
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-floating mb-3" >
                            <input type="text" class="form-control <?php if($errors->has('berdasarkan')): ?> is-invalid <?php endif; ?>" name="berdasarkan" id="berdasarkan" placeholder="" value="<?php if(old('berdasarkan')){ echo old('berdasarkan'); }else{ echo $surat->berdasarkan; } ?>">
                        ...
                        <div class="form-floating mb-3" >
                            <input type="text" class="form-control <?php if($errors->has('keperluan')): ?> is-invalid <?php endif; ?>" name="keperluan" id="keperluan" placeholder="" value="<?php if(old('keperluan')){ echo old('keperluan'); }else{ echo $surat->keperluan; } ?>">
                        ...
                        <div class="form-floating mb-3 col-md-6" >
                            <input type="text" class="form-control <?php if($errors->has('tempat')): ?> is-invalid <?php endif; ?>" name="tempat" id="tempat" placeholder="" value="<?php if(old('tempat')){ echo old('tempat'); }else{ echo $surat->tempat; } ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\suratIzin\ubah.blade.php ENDPATH**/ ?>