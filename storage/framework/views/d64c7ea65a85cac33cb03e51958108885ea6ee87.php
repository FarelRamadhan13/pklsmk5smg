                                ...
                                <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center">
                                            <?php if($u->foto_siswa != 'default.png'): ?>
                                                <div class="shiny-image">
                                                    <a href="<?php echo e(asset('storage/foto_profile_siswa/' . $u->foto_siswa)); ?>" data-fancybox="gallery" data-caption="Foto Profil <?php echo e($u->nama_siswa); ?>">
                                                        <img loading="lazy" src="<?php echo e(asset('storage/foto_profile_siswa/' . $u->foto_siswa)); ?>" style="width: 11.5vh; height: 11.5vh;" alt="Foto Profil <?php echo e($u->nama_siswa); ?>" class="rounded-circle" id="profileImage">
                                                    </a>
                                                </div>
                                                <a href="#" class="text-decoration-none position-relative text-light delete-foto" data-id="<?php echo e($u->nisn); ?>" data-username="<?php echo e($u->nama_siswa); ?>" data-foto="<?php echo e(asset('storage/foto_profile_siswa/' . $u->foto_siswa)); ?>" id="editLink">
                                                    <span class="position-absolute translate-middle shadow" id="editIcon">
                                                        <i class="fas fa-trash-alt text-secondary"></i>
                                                    </span>
                                                </a>
                                            <?php else: ?>
                                                <img loading="lazy" src="<?php echo e(asset('storage/foto_profile_siswa/' . $u->foto_siswa)); ?>" alt="" class="rounded-circle" style="width: 10vh; height: 10vh;" srcset="">
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center"><?php echo e($u->nisn); ?></td>
                                        <td class="text-center"><?php echo e($u->nama_siswa); ?></td>
                                        <td class="text-center"><textarea style="width: 220px;" rows="5" class="form-control" readonly><?php echo e($u->alamat); ?></textarea></td>
                                        ...
                                        <td class="text-center">
                                            <form id="delete-form-<?php echo e($u->nisn); ?>" action="<?php echo e(route('siswa.destroy', $u->nisn)); ?>" method="POST" style="display: none;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($u->nisn); ?>" style="display: none;">Hapus</button>
                                            </form>
                                            <a href="#" class="btn btn-danger delete-user" data-id="<?php echo e($u->nisn); ?>" data-username="<?php echo e($u->nama_siswa); ?>">Hapus</a>
                                            <a href="/Admin/siswa/edit/<?php echo e($u->nisn); ?>" class="btn btn-warning">Ubah</a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\siswa\index.blade.php ENDPATH**/ ?>