                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="id_pkl" id="id_pkl" class="form-select @if($errors->has('id_pkl')) is-invalid @endif">
                                ...
                                @foreach($pkl as $p)
                                    <option value="{{$p->idpkl}}" <?php if(old('id_pkl') == $p->idpkl){ echo 'selected'; } ?>>{{$p->idpkl}} || {{$p->nama_pkl}}</option>    
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="nisn" id="nisn" class="form-select @if($errors->has('nisn')) is-invalid @endif">
                                ...
                                @foreach($siswa as $s)
                                    <option value="{{$s->nisn}}" <?php if(old('nisn') == $s->nisn){ echo 'selected'; } ?>>{{$s->nisn}} || {{$s->nama_siswa}}</option>    
                                @endforeach
                            </select>
                            @if($errors->has('nisn'))
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="nip" id="nip" class="form-select @if($errors->has('nip')) is-invalid @endif">
                                ...
                                @foreach($guru as $g)
                                    <option value="{{$g->nip}}" <?php if(old('nip') == $g->nip){ echo 'selected'; } ?>>{{$g->nip}} || {{ $g->nama }}</option>    
                                @endforeach
                            </select>
                            @if($errors->has('nip'))
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <input type="date" name="start" id="start" class="form-control @if($errors->has('start')) is-invalid @endif" value="{{old('start')}}">
                            @if($errors->has('start'))
                            <div class="invalid-feedback">
                                {{$errors->first('start')}}
                            </div>
                        ...
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <input type="date" name="end" id="end" class="form-control @if($errors->has('end')) is-invalid @endif"value="{{old('end')}}">
                            @if($errors->has('end'))
                            <div class="invalid-feedback">
                                {{$errors->first('end')}}
                            </div>
