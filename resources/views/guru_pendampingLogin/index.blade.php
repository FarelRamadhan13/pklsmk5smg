...
<img id="profile-picture" 
     src="{{asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping)}}" 
     alt="Foto Profil" 
                    ...
                    <div class="container">
                        {{-- <div class="mx-auto d-flex justify-content-center align-items-center position-relative">
                            <a href="/Pendamping/gantiFoto" class="text-decoration-none position-relative text-light" id="editLink">
                                <img src="{{asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping)}}" style="width: 10vh; height:10vh;" alt="" class="rounded-circle" id="profileImage">
                        ...
                        <div class="mx-auto d-flex justify-content-center align-items-center position-relative">
                            <div class="shiny-image">
                                <a href="{{ asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping) }}" data-fancybox="gallery" data-caption="Foto Profil {{auth()->guard('pendamping')->user()->nama}} @if(auth()->guard('pendamping')->user()->foto_pendamping == 'default.png') (kosong) @endif">
                                    <img src="{{ asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping) }}" style="width: 11.5vh; height: 11.5vh;" alt="Foto Profil {{auth()->guard('pendamping')->user()->nama}}" class="rounded-circle" id="profileImage">
                                </a>
                            </div>
                            <a href="/Pendamping/gantiFoto" class="text-decoration-none position-relative text-light" id="editLink">
                        ...
                        <table class="table mt-5">
                            <tr>
                                <th scopr="row">NIP </th>
                                <td> : {{auth()->guard('pendamping')->user()->nip}}</td>
                            </tr>
                            <tr>
                                <th>Nama </th>
                                <td> : {{auth()->guard('pendamping')->user()->nama}}</td>
                            </tr>
                            <tr>
                                <th>Alamat </th>
                                <td> : {{auth()->guard('pendamping')->user()->alamat}}</td>
                            </tr>
                            <tr>
                                <th>Nomor telephone </th>
                                <td> : {{auth()->guard('pendamping')->user()->telp}}</td>
                            </tr>

                            <tr>
                                <th>Tahun </th>
                                <td> : {{auth()->guard('pendamping')->user()->tahun}}</td>
                            </tr>
                            <tr>
                                <th>Jurusan </th>
                            ...
                            <tr>
                                <th>Status </th>
                                <td> : @if(auth()->guard('pendamping')->user()->status === '0') Aktif @else Non Aktif @endif</td>
                            </tr>
                            <tr>
                                <th>Jurusan </th>
                                <td> : {{$jurusan->nama_jurusan}}</td>
                            ...
                            <tr>
                                <th>Jabatan </th>
                                <td> : {{auth()->guard('pendamping')->user()->jabatan}}</td>
                            </tr>
                            <tr>
                                <th>Pangkat </th>
                                <td> : {{auth()->guard('pendamping')->user()->pangkat}}</td>
                            </tr>
                        </table>
                        <style>
 .edit-button {
...
document.addEventListener("DOMContentLoaded", () => {
    const fullName = "{{ auth()->guard('pendamping')->user()->nama }}";
