        ...
        <div class="col-md-7">
            <div class="card mt-5">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="my-4">
                        <a href="#" onclick="window.close()" class="btn btn-danger">Kembali</a>
                    </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="pilih" id="tentukan" class="form-select">
                                <option value="">Semua Jurusan yang tersedia</option>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\siswa\tentukan.blade.php ENDPATH**/ ?>