                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="Form">
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="<?php echo e(asset('storage/kegiatan/camera.gif')); ?>" class="fancybox" data-fancybox="gallery" id="imageLink">
                                        <img src="<?php echo e(asset('storage/kegiatan/camera.gif')); ?>" style="width: 150px; height:150px;" class="img-preview <?php if($errors->has('foto')): ?> is-invalid <?php endif; ?>" alt="" id="imagePreview">
                                    </a>
                                    <script>
                        ...
                        <div class="form-floating my-3">
                            <input type="text" class="form-control <?php if($errors->has('uraian')): ?> is-invalid <?php endif; ?>" name="uraian" id="uraian" placeholder="" value="<?php echo e(old('uraian')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\kegiatan\tambah.blade.php ENDPATH**/ ?>