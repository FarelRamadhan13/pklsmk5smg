...
<?php if($carousel->action == '1'): ?>
<?php if($fotoPertama != null && $foto != null): ?>
<div class="carousel slide" data-bs-ride="carousel" id="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo e(asset('galeri/' . $fotoPertama->foto)); ?>" alt="" class="d-block w-100">
        </div>
        ...
        <div class="carousel-item">
            <img src="<?php echo e(asset('galeri/' . $f->foto)); ?>" alt="" class="d-block w-100">
        </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center"> <?php echo e($u->siswa_count); ?> Siswa</td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\welcome.blade.php ENDPATH**/ ?>