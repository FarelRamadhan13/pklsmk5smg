                        ...
                        <tbody>
                            @foreach($surat as $u)
                                <tr>
                                    ...
                                    <td class="text-center">{{$u->prakerin}}</td>
                                    ...
                                    <td class="text-center"><a href="/suratPenarikan/lihat/{{$u->id}}" target="_BLANK">Lihat file</a></td>
                                    @if(auth()->check())
                                    <td class="text-center">  <form id="delete-form-{{ $u->id }}" action="{{ route('penarikan.destroy', $u->id) }}" method="POST" style="display: none;">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger" id="delete-btn-{{ $u->id }}" style="display: none;">Hapus</button>
</form>

<a href="#" class="btn btn-danger delete-user" data-id="{{ $u->id }}" data-username="{{ $u->nama_siswa }}">
    Hapus
</a>  <a href="/Admin/suratPenarikan/edit/{{$u->id}}" class="btn btn-warning">Ubah</a> </td>
                                    @endif
                                </tr>
                            @endforeach
                        </tbody>
