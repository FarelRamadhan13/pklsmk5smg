                                ...
                                @foreach($users as $u)
                                    <tr>
                                        <td class="text-center">{{$no++}}</td>
                                          <td class="text-center"><img src="{{asset('storage/fotoProfileAdmin/' . $u->foto)}}" style="height: 70px; width: 70px;" class="rounded-circle" alt=""></td>
                                        <td class="text-center">{{$u->name}}</td>
                                        <td class="text-center">{{$u->username}}</td>
                                      
                                        <td class="text-center">@if($u->hak_akses == '1') Kepsek @elseif($u->hak_akses == '2') K3 @elseif($u->hak_akses == '0') Administrator @endif</td>
...
@endif
                                            ...
                                            <a href="/Admin/Users/edit/{{$u->id}}" class="btn btn-warning"><i class="fas fa-pencil"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
