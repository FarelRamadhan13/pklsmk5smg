                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="idprakerin" id="idprakerin" class="form-select @if($errors->has('idprakerin')) is-invalid @endif" <?php if(auth()->guard('pendamping')->check()){ echo 'disabled'; } ?>>
                                <option value="" disabled selected hidden>Pilih Id Prakerin</option>
                                @foreach($prakerin as $p)
                                    <option value="{{$p->idprakerin}}" <?php if(old('idprakerin')){ if(old('idprakerin') == $p->idprakerin){ echo 'selected'; }}
                                    else{ if($kunjungan->idprakerin == $p->idprakerin)
                                    { echo 'selected'; } } ?>>{{$p->idprakerin}}</option>    
                                @endforeach
                            </select>
                        ...
                        @if(auth()->guard('pendamping')->check()) <input type="hidden" name="idprakerin" value="{{$kunjungan->idprakerin}}"> @endif
                        ...
                        <div class="form-group mb-3 col-md-8">
                            ...
                            <input type="file" name="file" id="file" class="form-control @if($errors->has('file')) is-invalid @endif">
                            @if($errors->has('file')) 
                            <div class="invalid-feedback">
                                {{$errors->first('file')}}
                            </div>
