                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-10 mb-3">
                            ...
                            <select name="prakerin" id="prakerin" class="form-select <?php if($errors->has('prakerin')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $prakerin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->idprakerin); ?>" <?php if(old('prakerin') == $p->idprakerin){ echo 'selected'; } ?>>Id Prakerin: <?php echo e($p->idprakerin); ?> || NIS: <?php echo e($p->nisn); ?> || Nama: <?php echo e($p->nama_siswa); ?></option>    
                        ...
                        <div class="form-floating mb-3 col-md-10">
                            <input type="text" class="form-control <?php if($errors->has('alasan')): ?> is-invalid <?php endif; ?>" name="alasan" id="alasan" placeholder="" value="<?php echo e(old('alasan')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\suratPenarikan\tambah.blade.php ENDPATH**/ ?>