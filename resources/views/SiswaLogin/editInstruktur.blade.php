                ...
                <div class="card-body p-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3 col-md-10">
                            <input type="text" class="form-control @if($errors->has('nama_instruktur')) is-invalid @endif" name="nama_instruktur" id="nama_instruktur" placeholder="" required value="<?php if(old('nama_instruktur')){ echo old('nama_instruktur'); }else{ echo $surat->nama_instruktur; } ?>">
