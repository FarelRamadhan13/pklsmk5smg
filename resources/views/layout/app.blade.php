...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fancyapps/ui@4.0/dist/fancybox.css">
  ...
  <script src="https://cdn.jsdelivr.net/npm/animejs@3.2.1/lib/anime.min.js"></script>
    ...
    <link rel="stylesheet" href="{{asset('aset/css/custom-bootstrap.css')}}">
    ...
    <nav class="navbar bg-body-tertiary fixed-top">
        <div class="container">
            <a href="/Admin" class="navbar-brand">
                <img src="{{asset('storage/fotoProfileAdmin/' . auth()->user()->foto)}}" style="width: 20px; height: 20px;" class='rounded-circle' alt="" srcset="">
                <span id="nama_atas" username="{{auth()->user()->username}}" name="{{auth()->user()->name}}"></span>
          ...
          <div class="offcanvas offcanvas-end custom-offcanvas-width" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title d-flex align-items-center" id="offcanvasNavbarLabel">
                    <img src="{{asset('storage/fotoProfileAdmin/' . auth()->user()->foto)}}" style="width: 30px; height: 30px;" class='rounded-circle mb-1 me-2' alt="" srcset="">
            ...
            <div class="offcanvas-body d-flex flex-column">
              <ul class="navbar-nav justify-content-end flex-grow-1">
                <li class="nav-item">
                    <a href="/Admin/Users" class="nav-link @if($title == 'Daftar Users') active @endif">
                ...
                <li class="nav-item">
                    <a href="/pkl" class="nav-link  @if($title == 'Daftar PKL') active @endif">
                        <i class="fas fa-briefcase"></i> Industri
                    </a>
                </li>

                <li class="nav-item">
                    <a href="/Admin/jurusan" class="nav-link @if($title == 'Daftar jurusan') active @endif">
                        <i class="fas fa-graduation-cap"></i> Jurusan
                    </a>
                </li>

                <li class="nav-item">
                    <a href="/Admin/guru_pendamping" class="nav-link @if($title == 'Daftar Guru pendamping') active @endif">
                        <i class="fas fa-chalkboard-teacher"></i> Guru Pendamping
                    </a>
                </li>

                <li class="nav-item">
                    <a href="/Admin/Siswa" class="nav-link @if($title == 'Daftar Siswa') active @endif">
                        <i class="fas fa-user-graduate"></i> Siswa
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/Admin/Prakerin" class="nav-link @if($title == 'Daftar Prakerin') active @endif">
                        <i class="fas fa-list-alt"></i> Daftar Prakerin
                    </a>
                </li>
               
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle @if($title === 'Pengajuan Siswa' || $title === 'Surat Izin Siswa' || $title === 'Surat Penarikan Siswa' || $title == 'Daftar Surat tugas guru pendamping') active @endif" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-file-alt"></i> Dokumen
                    </a>

                    <ul class="dropdown-menu">
                        <li class="dropdown-header"><i class="fas fa-user"></i> Siswa</li>
                        <li><a class="dropdown-item @if($title == 'Pengajuan Siswa') active @endif" href="/Siswa/Pengajuan"><i class="fas fa-file-signature"></i> Surat Pengajuan &</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pengantar</a></li>
                        <li><a class="dropdown-item @if($title == 'Surat Izin Siswa') active @endif" href="/Siswa/suratIzin "><i class="fas fa-file-signature"></i> Surat Izin</a></li>
                        <li><a class="dropdown-item @if($title == 'Surat Penarikan Siswa') active @endif" href="/Siswa/suratPenarikan"><i class="fas fa-file-signature"></i> Surat Penarikan</a></li>
                        <li><a class="dropdown-item @if($title == 'Jurnal PKL') active @endif" href="/Siswa/JurnalPKL"><i class="fas fa-address-book"></i> Jurnal PKL</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li class="dropdown-header"><i class="fas fa-chalkboard-teacher"></i> Guru Pendamping</li>
                        <li><a class="dropdown-item @if($title == 'Daftar Surat tugas guru pendamping') active @endif" href="/Pendamping/Pengajuan"><i class="fas fa-file-signature"></i> Surat Tugas</a></li>
                        {{-- <li>
                            <hr class="dropdown-divider">
                        </li> --}}

                        {{-- <li class="dropdown-header"><i class="fas fa-envelope"></i> Pesan

                        <li><a class="dropdown-item " href="/Admin/Pesan"><i class="fas fa-file-signature"></i> Daftar Pesan</a></li> --}}
          ...
          <div class="offcanvas offcanvas-end custom-offcanvas-width" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body d-flex flex-column">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <a href="/prakerin" class="nav-link @if($title == 'Guru Prakerin') active @endif">
                        <i class="fas fa-tachometer-alt"></i> Dashboard
                    </a>
                </li>

                <li class="nav-item">
                    <a href="/prakerin/gantiPassword" class="nav-link @if($title == 'Ganti Data') active @endif">
        ...
        <div class="container">
          ...
          <div class="offcanvas offcanvas-end custom-offcanvas-width" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body d-flex flex-column">
              <ul class="navbar-nav justify-content-end flex-grow-1">
                <li class="nav-item">
                    <a href="/kepsek/gantiPassword" class="nav-link @if($title == 'Ganti Data') active @endif">
                        <i class="fas fa-lock"></i> Ganti Data
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/kepsek/Prakerin" class="nav-link @if($title == 'Daftar Prakerin') active @endif">
                        <i class="fas fa-list-alt"></i> Daftar Prakerin
                    </a>
                </li>
    ...
    <nav class="navbar bg-body-tertiary fixed-top">
        <div class="container">
            <a href="/Siswa" class="navbar-brand">
                <img src="{{asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)}}" style="width: 20px; height: 20px;" class='rounded-circle mb-1' alt="" srcset="">
                <span id="nama_atas" nisn="{{auth()->guard('siswa')->user()->nisn}}" nama="{{auth()->guard('siswa')->user()->nama_siswa}}"></span>
            </a>
          <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="offcanvas offcanvas-end custom-offcanvas-width" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title d-flex align-items-center" id="offcanvasNavbarLabel">
                    <img src="{{asset('storage/foto_profile_siswa/' . auth()->guard('siswa')->user()->foto_siswa)}}" style="width: 50px; height: 50px;" class='rounded-circle mb-1 me-2' alt="" srcset="">
                    <span class="text-truncate" style="max-width: 120px;">{{ ucwords(strtolower(auth()->guard('siswa')->user()->nama_siswa)) }}</span>
                </h5>                              
            ...
            <div class="offcanvas-body d-flex flex-column">
                <ul class="navbar-nav flex-grow-1">
                  <li class="nav-item">
                    <a href="/Siswa" class="nav-link @if($title == 'Siswa') active @endif">
                      <i class="fas fa-user"></i> Profile
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/Siswa/Prakerin" class="nav-link @if($title == 'Prakerin') active @endif">
                      <i class="fas fa-list-alt"></i> Prakerin
                    </a>
                  </li>
                
                   <li class="nav-item">
                    <a href="/Siswa/JurnalPKL" class="nav-link @if($title == 'Jurnal PKL') active @endif">
                  ...
                  @if($cekJurnal != 0)
                  <li class="nav-item">
                    <a href="/Siswa/JurnalPKL/Absen/{{$jurnal->id}}" class="nav-link @if($title == 'Daftar hadir') active @endif">
                        <i class="fas fa-user-check"></i> Absen
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/Siswa/JurnalPKL/harian/{{$jurnal->id}}" class="nav-link @if($title == 'Daftar Kegiatan harian') active @endif">
    ...
    <nav class="navbar bg-body-tertiary fixed-top">
        <div class="container">
            <a href="/Pendamping" class="navbar-brand">
                <img src="{{asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping)}}" style="width: 20px; height: 20px;" class='rounded-circle' alt="" srcset="">
                <span id="nama_atas" nip="{{auth()->guard('pendamping')->user()->nip}}" nama="{{auth()->guard('pendamping')->user()->nama}}"></span>
            </a>
          <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="offcanvas offcanvas-end custom-offcanvas-width" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title d-flex align-items-center" id="offcanvasNavbarLabel">
                    <img src="{{asset('storage/foto_profile_guruPendamping/' . auth()->guard('pendamping')->user()->foto_pendamping)}}" style="width: 30px; height: 30px;" class='rounded-circle mb-1 me-2' alt="" srcset="">
                    <span class="text-truncate" style="max-width: 150px;">{{auth()->guard('pendamping')->user()->nama}}</span>
                </h5>
              <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body d-flex flex-column">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <a href="/Pendamping" class="nav-link @if($title == 'Guru Pendamping') active @endif">
                        <i class="fas fa-user"></i> Profile
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/Pendamping/Prakerin" class="nav-link @if($title == 'Daftar Prakerin') active @endif">
                        <i class="fas fa-list-alt"></i> Daftar Prakerin
                    </a>
                </li>
                <li class="nav-item">
...
.no-select {
    ...
    {{-- <a href="/Admin/Pesan" target="_BLANK" class="btn rounded-circle fixed-bottom-left">
...
function aboutPKL() {
    ...
    <script>
        ...
        //                 <input type="text" class="form-control" name="nama" id="nama" placeholder="" value="{{ auth()->guard('siswa')->user()->nama_siswa }}" disabled>
    ...
    @endif
           <script src="{{ asset('aset/js/scriptJava.js') }}"></script>
    <script>
