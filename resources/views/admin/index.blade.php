        ...
        <div class="col-md-4 mt-4">
            <a href="/Admin/guru_pendamping" class="text-decoration-none">
                <div class="card">
                    ...
                    <div class="card-body p-4 text-center">
                        <p>Terdapat {{$pendamping}} Data Guru pendamping</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-4 mt-4">
            <a href="/Siswa/Pengajuan" class="text-decoration-none">
                <div class="card">
                    ...
                    <div class="card-body p-4 text-center">
                        <p>Terdapat {{$pengajuan}} Surat Pengajuan</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-4 mt-4">
            <a href="/Pendamping/Pengajuan" class="text-decoration-none">
                <div class="card">
                    ...
                    <div class="card-body p-4 text-center">
                        <p>Terdapat {{$surat_pendamping}} Surat Tugas guru pendamping</p>
                    </div>
                </div>
            </a>
        </div>
