                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="nip" id="id_nip" class="form-select <?php if($errors->has('nip')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $pendamping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->nip); ?>" <?php if(old('nip')){ if(old('nip') == $p->nip){ echo 'selected'; }}else{ if($surat->nip == $p->nip){ echo 'selected'; }} ?>><?php echo e($p->nama); ?></option>    
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control <?php if($errors->has('tanggal')): ?> is-invalid <?php endif; ?>" name="tanggal" id="tanggal" placeholder="" value="<?php if(old('tanggal')){ echo old('tanggal'); }else{ echo $surat->tanggal; } ?>" >
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control <?php if($errors->has('lama')): ?> is-invalid <?php endif; ?>" name="lama" id="lama" placeholder="" value="<?php if(old('lama')){ echo old('lama'); }else{ echo $surat->lama; } ?>">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control <?php if($errors->has('tanggalberangkat')): ?> is-invalid <?php endif; ?>" name="tanggalberangkat" id="tanggalberangkat" placeholder="" value="<?php if(old('tanggalberangkat')){ echo old('tanggalberangkat'); }else{ echo $surat->tanggal_berangkat; } ?>" >
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control <?php if($errors->has('tanggalharuskembali')): ?> is-invalid <?php endif; ?>" name="tanggalharuskembali" id="tanggalharuskembali" placeholder="" value="<?php if(old('tanggalharuskembali')){ echo old('tanggalharuskembali'); }else{ echo $surat->tanggal_harus_kembali; } ?>" >
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="pkl" id="id_pkl" class="form-select <?php if($errors->has('pkl')): ?> is-invalid <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $pkl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->idpkl); ?>" <?php if(old('pkl')){ if(old('pkl') == $p->idpkl){ echo 'selected'; }}else{ if($surat->industri === $p->idpkl){ echo 'selected'; }} ?>><?php echo e($p->nama_pkl); ?></option>    
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('kendaraan')): ?> is-invalid <?php endif; ?>" name="kendaraan" id="kendaraan" placeholder="" value="<?php if(old('kendaraan')){ echo old('kendaraan'); }else{ echo $surat->kendaraan; } ?>">
                        ...
                        <div class="form-group mb-3 col-md-5">
                            ...
                            <select name="kepalasekolah" id="kepalasekolah" class="form-select   <?php if($errors->has('kepalasekolah')): ?> is-invalid <?php endif; ?>">
                                ...
                                <option value="<?php echo e($k->id); ?>" <?php if(old('kepalasekolah')){ if(old('kepalasekolah') == $k->id){ echo 'selected'; }}else{ if($surat->kepala_sekolah === $k->id){ echo 'selected'; }} ?>><?php echo e($k->name); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control <?php if($errors->has('keterangan')): ?> is-invalid <?php endif; ?>" name="keterangan" id="keterangan" placeholder="" value="<?php if(old('keterangan')){ echo old('keterangan'); }else{ echo $surat->keterangan; } ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\guru_pendampingLogin\tugasEdit.blade.php ENDPATH**/ ?>