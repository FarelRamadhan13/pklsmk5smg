...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let cooldownTime = {{ session('cooldown_time') }};
        let timerInterval;
...
@endif
                    <form method="post" id="loginForm">
                        ...
                        <div class="form-floating mb-3" id="nisn">
                            <input type="text" class="form-control @if($errors->has('username')) is-invalid @endif" name="username" id="username" placeholder="NIS/NIP">
