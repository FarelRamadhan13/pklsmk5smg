...
<div class="mx-auto d-flex justify-content-center align-items-center position-relative">
        <a href="/prakerin/gantiFoto" class="text-decoration-none position-relative text-light" id="editLink">
    ...
    <div class="col-md-4 mt-4">
        <a href="/prakerin/gantiPassword" class="text-decoration-none">
            <div class="card">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\prakerin\index.blade.php ENDPATH**/ ?>