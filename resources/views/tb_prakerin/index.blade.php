                                    ...
                                    <tr>
                                        ...
                                        @if(auth()->user()->hak_akses != '1')
                                            <td class="text-center">
                                                <form id="delete-form-{{ $p->idprakerin }}" action="{{ route('prakerin.destroy', $p->idprakerin) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger" id="delete-btn-{{ $p->idprakerin }}" style="display: none;">Hapus</button>
                                                </form>
                                                <a href="#" class="btn btn-danger delete-user" data-id="{{ $p->idprakerin }}" data-username="{{ $p->nama_siswa }}">
                                                    Hapus
                                                </a>
                                                <a href="/Admin/Prakerin/Ubah/{{$p->idprakerin}}" class="btn btn-warning">Ubah</a>
                                            </td>
                                        @endif
                                    </tr>
                                @endforeach
