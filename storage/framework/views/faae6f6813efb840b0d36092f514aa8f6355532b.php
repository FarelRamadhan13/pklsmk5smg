...
<a class="download-btn fixed-bottom-right" href="/Siswa/JurnalPKL/Absen/pdf/<?php echo e($id); ?>" id="animatedBtn">
  <svg
    id="download"
    viewBox="0 0 24 24"
    data-name="Layer 1"
        ...
        <div class="col-md-9">
            <div class="card mt-5">
                <div class="card-header text-center py-4">
                    <div class="d-flex justify-content-center align-items-center">
                        <h1 class="mb-0" id="student-name">Daftar Hadir <?php echo e($jurnal->nama_siswa); ?></h1>
                        <script>
            ...
            return str.toLowerCase().replace(/\b(\w)/g, function(match) {
                ...
                <div class="card-body p-5">
                    ...
                    <?php endif; ?>
                    <?php if($cek_absen->start > $cek_hari): ?>
                    <script>
                    ...
                    <div class="d-flex justify-content-end my-3">
                        ...
                        <div class="col-auto ms-3" id="absen_cek">
                            ...
                            <script>
                             ...
                             <p>Belum mulai PKL</p>
                            <?php elseif($cek_absen->end < $cek_hari): ?>
                            <script>
...
.Btn:active {
  transform: translate(2px ,2px);
                            ...
                            <!-- <a class="Btn" href="/Siswa/JurnalPKL/Absensi/<?php echo e($id); ?>">
...
.Btn:hover::after {
 ...
 opacity: 0;
                    ...
                    <a href="/Siswa/JurnalPKL/Absensi/<?php echo e($id); ?>" id="datang" class="Btn"><i class="fa-solid fa-door-open"></i> Absen datang
                    </a>
                           ...
                           <a>Absen datang pada pukul: <?php echo e($sudah_absen->waktu_datang); ?></a></br>
                           <a>Absen pulang pada pukul: <?php echo e($sudah_absen->waktu_pulang); ?></a></br>
                            </div>
 ...
 .Btn:active {
   transform: translate(2px ,2px);
                             ...
                             <!-- <a class="Btn" href="/Siswa/JurnalPKL/Absensi/<?php echo e($jurnal->id); ?>/pulang/<?php echo e($absen->id_hadir); ?>">
                             ...
                             <a class="Btn" id="pulang" href="/Siswa/JurnalPKL/Absensi/<?php echo e($jurnal->id); ?>/pulang/<?php echo e($absen->id_hadir); ?>"><i class="fa-solid fa-door-closed"></i> Absen pulang
                               </a>
...
.radio-input label:nth-child(2):has(input:checked) ~ .selection {
  transform: translateX(calc(var(--container_width) * 1 / 2));
              ...
              <?php if(auth()->guard('siswa')->check()): ?>
                  <?php if($cek_kegiatan < 1 && $cek_hadir_hari == 1): ?>
...
.pengingat4:hover .go-arrow {
  opacity: 1;
                          ...
                          <div class="pengingat mt-4">
                            <a class="pengingat1" href="/Siswa/JurnalPKL/harian/tambah/<?php echo e($jurnal->id); ?>">
                             <p>Kegiatan harian</p>
                             <p class="small">Kamu belum menambahkan kegiatan harian untuk hari ini, klik ini untuk tambah sekarang</p>
                             <div class="go-corner" href="/Siswa/JurnalPKL/harian/tambah/<?php echo e($jurnal->id); ?>">
                               <div class="go-arrow">
                                 →
                               </div>
                             </div>
...
<div class="row justify-content-center mt-4">
  <div class="mt-4">
    <div class="text-center">
      ...
      <p class="mt-3">
        Hadir: <?php echo e($hadir > 0 ? $hadir . ' kali' : 'Tidak pernah'); ?> | Izin: <?php echo e($izin > 0 ? $izin . ' kali' : 'Tidak pernah'); ?>. </br> Kurang Sesuai: <?php echo e($kurang_sesuai > 0 ? $kurang_sesuai . ' kali' : 'Tidak pernah'); ?>.</br>
         Total: <?php echo e($hadir + $izin); ?> kali. </br></br>

        Rata rata waktu datang <?php echo e($averageTimeDatang); ?>. </br>
        Rata rata waktu pulang <?php echo e($averageTimePulang); ?>. </br>
      ...
      <script>
        ...
        const hadir = <?php echo e($hadir ?? 0); ?>;
        const izin = <?php echo e($izin ?? 0); ?>;
        const kurangSesuai = <?php echo e($kurang_sesuai ?? 0); ?>;
        ...
        new Chart(ctx, {
          ...
          options: options
            ...
            <div class="text-center mt-4">
              <h6>Riwayat absen Di <i>'<?php echo e($jurnal->nama_pkl); ?>'</i> berdasarkan</h6>
...
<div class="radio-input">
  ...
  <label>
<input name="toggle" id="pulangRadio" type="radio" <?php if(session('pulang')): echo 'checked'; endif; ?> />
  ...
  <span class="selection"></span>
    ...
    <thead>
        <tr>
            ...
            <?php if((auth()->check() && auth()->user()->hak_akses == '0') || auth()->guard('pendamping')->check()): ?>
...
<?php endif; ?>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="<?php if($u->waktu_pulang != null && $u->waktu_datang > $u->waktu_pulang): ?> alert alert-danger <?php endif; ?> <?php if($u->validasi_datang == 3 || $u->validasi_datang == 5 || $u->validasi_pulang == 3 || $u->validasi_pulang == 5): ?> alert alert danger <?php endif; ?> ">
...
?>
<td class="text-center"><?php echo e($tanggal); ?> </br> <?php echo e($label); ?></td>

                <td class="text-center datang">
                  <a href="<?php echo e(asset('storage/foto_siswa_datang/' . $u->foto_datang)); ?>" class="fancybox" data-fancybox="gallery" data-caption=" <?php if($u->izin != '1'): ?> Absen datang pada hari <?php echo e($tanggal); ?> pukul <?php echo e($u->waktu_datang); ?> <?php else: ?> Izin pada hari <?php echo e($tanggal); ?> pukul <?php echo e($u->waktu_datang); ?> <?php endif; ?>">
                    <img src="<?php echo e(asset('storage/foto_siswa_datang/' . $u->foto_datang)); ?>" style="height: 150px; width: 150px; image-rendering: pixelated;" alt="Foto Datang" title="Lihat Foto" loading="lazy" class="lazyload">
                </a>
                </td>
                <td class="text-center datang"><?php echo e($u->waktu_datang); ?></td>
                <td class="text-center datang">
                  <?php if($u->izin != '1'): ?>
                  <div style="position: relative; display: inline-block; width: 190px; height: 150px;">
                    <iframe allowfullscreen=""
                            src="https://www.google.com/maps?q=<?php echo e($u->latitude); ?>,<?php echo e($u->longitude); ?>&hl=es;z=14&output=embed"
                            frameborder="1" width="190" height="150" style="border:0;" loading="lazy"></iframe>

                    <div class="datangMap" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: pointer;" tanggal="<?php echo e($tanggal); ?>" data-latitude="<?php echo e($u->latitude); ?>" data-longitude="<?php echo e($u->longitude); ?>"></div>
                </div>
                ...
                <td class="text-center pulang">
                  <?php if($u->izin != '1'): ?>
                  <?php if($u->foto_pulang): ?>
                      <a href="<?php echo e(asset('storage/foto_siswa_pulang/' . $u->foto_pulang)); ?>" class="fancybox" data-fancybox="gallery" data-caption="Absen pulang pada hari <?php echo e($tanggal); ?> pukul <?php echo e($u->waktu_pulang); ?>">
                          <img src="<?php echo e(asset('storage/foto_siswa_pulang/' . $u->foto_pulang)); ?>" style="height: 150px; width: 150px; image-rendering: pixelated;" alt="Foto Pulang" title="Lihat Foto" loading="lazy" class="lazyload">
                      </a>
                  <?php else: ?>
  ...
  <div class="line"></div>
                ...
                <td class="text-center pulang"><?php if($u->izin != '1'): ?><?php if($u->waktu_pulang != null): ?> <?php echo e($u->waktu_pulang); ?> <?php else: ?>
 ...
 <svg height="48px" width="64px">
   ...
   <polyline id="front" points="0.157 23.954, 14 23.954, 21.843 48, 43 0, 50 24, 64 24"></polyline>
                   ...
                   <?php else: ?>
                   <?php if($u->latitude_pulang && $u->longitude_pulang): ?>
                       
                       <div style="position: relative; display: inline-block; width: 190px; height: 150px;">
                         <iframe allowfullscreen=""
                                 src="https://www.google.com/maps?q=<?php echo e($u->latitude_pulang); ?>,<?php echo e($u->longitude_pulang); ?>&hl=es;z=14&output=embed"
                                 frameborder="1" width="190" height="150" style="border:0;" loading="lazy"></iframe>

                         <div class="pulangMap" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; cursor: pointer;" tanggal="<?php echo e($tanggal); ?>" data-latitude="<?php echo e($u->latitude_pulang); ?>" data-longitude="<?php echo e($u->longitude_pulang); ?>"></div>
                     </div>
...
@keyframes bounce {
  ...
  <div class="line"></div>
                  ...
                  <td class="text-center pulang">
                  <?php if($u->validasi_pulang !== null): ?>
                  <?php if($u->validasi_pulang === 0): ?>
                        <p class="text-success">Lokasi & waktu absen sesuai</p>
                      <?php elseif($u->validasi_pulang == 1): ?>
                        <p class="text-warning">Waktu absen tidak sesuai & lokasi absen sesuai</p>
                      <?php elseif($u->validasi_pulang == 2): ?>
                        <p class="text-warning"> Waktu absen sesuai & lokasi absen tidak sesuai</p>
                        <?php elseif($u->validasi_pulang == 3): ?>
                        <p class="text-danger">Waktu & lokasi absen tidak sesuai</p>
                        <?php elseif($u->validasi_pulang == 4): ?>
                        <p class="text-primary">Diizinkan</p>
                        <?php elseif($u->validasi_pulang == 5): ?>
                        <p class="text-danger">Tidak diizinkan</p>
                        <?php endif; ?>
                     <?php else: ?>
                      Belum di validasi oleh <a href="#" class="pendamping" >guru pendamping</a>
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Oke'
                ...
                <td class="text-center">
                        ...
                        <form id="delete-form-<?php echo e($u->id_hadir); ?>" action="<?php echo e(route('hadir.destroy', $u->id_hadir)); ?>" method="POST" style="display: none;">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-danger" id="delete-btn-<?php echo e($u->id_hadir); ?>" style="display: none;">Hapus</button>
                        </form>
                        <a href="#" class="btn btn-danger delete-user" data-id="<?php echo e($u->id_hadir); ?>">Hapus</a>
                    </td>
                    <?php endif; ?>
...
.custom-button:active .button-top {
  ...
  transition:
    ...
    box-shadow 0.1s ease;
                    ...
                    <td class="text-center">
                        <?php if($u->waktu_pulang == null): ?>
                        <p>Menunggu absen pulang...</p>
                        <?php else: ?>
       <?php if($u->validasi_datang === null && $u->validasi_pulang === null): ?>
    <button class="custom-button validate-button" id="validate-button" validasi-id="<?php echo e($u->id_hadir); ?>" tanggal="<?php echo e($tanggal); ?>" izin="<?php echo e($u->izin); ?>">
...
<script src="<?php echo e(asset('aset/js/AmbilLokasi.js')); ?>">
...
<?php if(auth()->guard('siswa')->check()): ?>
<?php if($cek_absen->start <= $cek_hari && $cek_absen->end >= $cek_hari): ?>
<?php if(!session('berhasil')): ?>
<?php if($absen != null): ?>
<?php
$jam_cek = '15:30';
...
$now = Carbon::now();
?>
<?php if($now->greaterThan($tanggal_absen->setTimeFromTimeString($jam_cek)) || !$now->isSameDay($tanggal_absen)): ?>
<script>
   function toTitleCase(str) {
    return str.toLowerCase().replace(/\b(\w)/g, function(match) {
        return match.toUpperCase();
...
function absen() {
    var id = "<?php echo e($jurnal->id); ?>";
    var userName = "<?php echo e(Auth::guard('siswa')->user()->nama_siswa); ?>";
...
absen();
         ...
         <?php endif; ?>
         <?php endif; ?>
<?php if($cek_hadir_hari < 1 && $absen == null): ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\hadir\index.blade.php ENDPATH**/ ?>