            ...
            <div class="card mt-5">
                <div class="card-header text-center py-4">
                    <div class="d-flex justify-content-center align-items-center">
                        <h1 class="mb-0">Tentukan data absen</h1>
                    </div>
                </div>
                    ...
                    <div class="my-4">
                        <style>
                            ...
                            #1{
                              ...
                              <a class="kembali text-decoration-none" href="/Siswa/JurnalPKL/Absen/<?php echo e($id); ?>">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="Form">
                        ...
                        <div class="form-group mb-4 col-md-8">
                            ...
                            <select name="tentukan" id="tentukan" class="form-select">
                                <option value="0" <?php if(old('tentukan') == '0'){ echo 'selected'; } ?>>Semua absen</option>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\smk\pklsmk5smg\resources\views\hadir\tentukan.blade.php ENDPATH**/ ?>